    ...
    setup() {
        ...
        onMounted(async () => {
            ...
            try {
                ...
                console.log('Данные черновика с сервера:', draftResponse.data) // ← ДОБАВЬТЕ ЭТО
                console.log('manual.data:', draftResponse.data?.manual) // ← ДОБАВЬТЕ ЭТО
                console.log('tools:', draftResponse.data?.manual?.tools) // ← ДОБАВЬТЕ ЭТО
                console.log('materials:', draftResponse.data?.manual?.materials) // ← ДОБАВЬТЕ ЭТО
